...
const Audit=()=>{
    ...
    return(
        ...
        <div>
        <Navbar />        
        <Section2 img="img/cof.png" titre="Optimisez vos process en intégrant ChatGPT et l’IA"  para="Mathilda IA réalise un audit complet de vos processus et propose des recommandations personnalisées pour déployer efficacement ChatGPT et d'autres outils d'IA, améliorant ainsi les performances et la productivité de votre entreprise." />
